    ...
    void bst_impl<tkey, tvalue, compare, tag>::erase(binary_search_tree<tkey, tvalue, compare, tag>& cont, typename binary_search_tree<tkey, tvalue, compare, tag>::node** node_ptr)
    {
        ...
        else
        {
            ...
            if (successor->parent->left_subtree == successor)
                successor->parent->left_subtree = successor->left_subtree;
            else
                successor->parent->right_subtree = successor->left_subtree;

            if (successor->left_subtree)
                successor->left_subtree->parent = successor->parent;
            ...
            if (successor->parent)
            {
                if (successor->parent->left_subtree == node)
                    successor->parent->left_subtree = successor;
                else
                    successor->parent->right_subtree = successor;
            }
            else
            {
