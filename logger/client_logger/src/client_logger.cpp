...
client_logger::refcounted_stream::refcounted_stream(const client_logger::refcounted_stream &other) : _stream(other._stream)
{
...
client_logger::refcounted_stream::refcounted_stream(client_logger::refcounted_stream &&other) noexcept : _stream(std::move(other._stream))
{
    other._stream = {other._stream.first, nullptr};
}
